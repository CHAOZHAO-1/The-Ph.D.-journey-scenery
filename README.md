...
这个库汇总了我在读博过程中遇到的一些问题以及通过研究找到的优秀答案。

我希望它能对大家的研究进展有所帮助。

提出正确的问题往往等于解决了问题的一半。 —— 维尔纳·卡尔·海森堡

**注：此库中问题的所有答案均为转载！如果有侵权，请联系我删除。**
...
1. 每天阅读文献，进行**批判性阅读**。了解本领域最近进展，只看文章的标题和摘要，遇到感兴趣的和重要的留下来重点关注。
   
2. 熟悉本领域全球著名课题组、教授或团队，了解各自的风格和长处。尝试与这些人包括论文中的大牛见面，聊天，甚至建立更深入的联系。这有助于建立未来在博士后、学术界、工业界工作甚至申请国外绿卡时的科研人脉。

3. 参加学术或行业会议。演讲训练，如做presentation的能力。

4. 培养心态。训练抗压能力，在面对拒稿、卡壳、被抢发等外力因素时保持平常心，不受负面情绪（如嫉妒、不甘）影响效率。

5. 绘图能力的训练。

6. 实验记录的训练。

7. 英语表达能力：熟练进行日常对话、写作、阅读。

8. 提高信息收集能力：能快速准确地找到所需的论文、知识点或代码，避免浪费时间重复劳动或使用过时的工具。

9. 培养交叉学科能力：发现不同领域、不同工具或不同流派的交集，完成交叉类研究。

10. 注重研究深度，专注于关键问题而不是无关紧要的概念、涨点、调参或小改进。

11. 管理时间，包括课业、研究、审稿、助教、阅读文献、演讲、实习、合作伙伴之间的时间管理，避免错过截止日期。

12. 管理精力，保持稳定体重、充足睡眠，避免产生心理和精神问题。
...
- 创新点是什么。论文要清晰地表述所提出的新发现、新假设和理论，界定相应概念和变量的内涵和外延。

- 为何要提出此创新点。论文要交代创新点提出的实际或理论背景，既说服自己也让读者感到这样的创新点的确有学术和实际意义，值得费精力去研究。

- 回答这个创新点是否成立的质疑。提出证据和论据来支持论文的创新点。为了回答上述问题，相应有三方面的内容，即创新点的表述，创新点的理论和实际背景评述以及创新点的论证。表述反映论文的贡献所在，背景评述衬托出论文的价值，论证则表明创新点的可信程度，三者缺一不可。只提出某种观点、说法或模式而缺乏背景评述，读者难以了解其创新的份量和作者工作的价值，而有价值的假设或理论还需充分的论证支持，否则，读者将难以置信，不能放心引用。
...
注：这部分内容是观看B站Up主[老司机耿进财]（https://space.bilibili.com/81249447/channel/collectiondetail?sid=2454838&spm_id_from=333.788.0.0）的系列视频摘的笔记。
